...
const devWebpackConfig = merge(baseWebpackConfig, {
  ...
  devServer: {
    ...
    before (app) {
      ...
      app.get('/api/getPlayVkeys', function (req, res) {
      ...
      // app.post('/api/getPlayVkeys', function (req, res) {
      ...
      // app.post('/getPlayVkeys', function (req, res) {
      //   const url = 'https://u.y.qq.com/cgi-bin/musicu.fcg'
      //   var data = req.query
      //   axios.post(url, {
      //     headers: {
      ...
      app.get('/api/volData', function (req, res) {
        res.json({
          errno: 0,
          data: volData
        })
