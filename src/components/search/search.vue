<template>
  <transition name="searchAnimation">
    <div class="search">
      ...
      <div ref="shortcutWrapper" :refreshDelay="refreshDelay" class="shortcut-wrapper" v-show="!query">
      ...
      <confirm ref="confirm" @confirm="clearSearchHistory" text="是否清空搜索" confirmBtnText="清空"></confirm>
